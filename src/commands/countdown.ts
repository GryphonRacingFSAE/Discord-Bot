...
export default function createCommand() {
    if (!process.env.EMAIL_USERNAME || !process.env.EMAIL_PASSWORD || !(process.env.EMAIL_HOST || process.env.EMAIL_SERVICE) || !process.env.EMAIL_PORT) {
        console.warn("countdown commands has been disabled");
        return null;
    } else {
        return {
            ...
            async execute(interaction: CommandInteraction) {
                ...
                switch (options.getSubcommand()) {
                    case "add": {
                        ...
                        await addCountdown(interaction.client, interaction.channelId, message_input);
                    ...
                    case "remove": {
                        ...
                        await deleteCountdown(interaction.client, interaction.channelId, event_name);
                        updateMessage(interaction.client, interaction.channelId, true, true, null).then(() => {
